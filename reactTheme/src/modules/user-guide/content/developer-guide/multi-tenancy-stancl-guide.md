...
flowchart TB
    ...
    subgraph DBs["MySQL"]
      CDB[("central DB<br/>tenants, domains, plans,<br/>subscriptions, invoices")]
      T1[("tenant_school1<br/>users, roles, orders, students...")]
      T2[("tenant_school2<br/>users, roles, orders, students...")]
    end
