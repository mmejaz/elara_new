...
function AddLeaveTypeDrawer() {
  ...
  const open = useAppSelector((state) => state.leaveTypes.addDrawerOpen)
  const [form] = Form.useForm()
  const mutation = useCreateLeaveType()
...
export default AddLeaveTypeDrawer
