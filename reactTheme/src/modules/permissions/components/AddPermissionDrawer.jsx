...
import { closeAddDrawer } from '../../../store/permissionsSlice'
...
function AddPermissionDrawer() {
  ...
  const open = useSelector((state) => state.permissions.addDrawerOpen)
    ...
    mutation.mutate({ name }, {
      ...
      onError: (error) => {
        if (!applyServerErrors(error, form)) {
          message.error(serverMessage(error, 'Unable to create permission'))
        }
      },
    })
  }
